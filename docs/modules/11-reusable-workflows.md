...
> ➡️ **Full hands-on lab:** [Lab 11 — Reusable Workflows](../labs/lab-11-reusable-workflows.md) (check the [prerequisites matrix](../guides/advanced-track-prerequisites.md) first).
