---
title: "Lab 11 — OIDC Deployments (Azure)"
---
...
> [prerequisites matrix](../guides/advanced-track-prerequisites.md). Do Lab 10 first — this
...
Approve the environment gate (from Lab 10). The `az account show` step proves you authenticated
...
Continue to [Lab 12 — Reusable Workflows](lab-12-reusable-workflows.md).
